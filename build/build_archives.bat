...
set higurashiData=HigurashiEp07_Data
...
set assetsLinuxMacOsSteamGogMangaGamer=LinuxMac-Steam-GOG-MG-5.6.7f1.languagespecificassets

set output07th=minagoroshi_ita_07th_mod_installer.7z
set outputWindowsSteamGogMangaGamer=minagoroshi_ita_windows_steam_gog_mg_%version%.7z
set outputLinuxMacOsSteamGogMangaGamer=minagoroshi_ita_linux_macos_steam_gog_mg_%version%.7z
